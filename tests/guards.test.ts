...
describe("Guard Utilities", () => {
  describe("ensureObject", () => {
    ...
    it("should throw on null", () => {
      expect(() => ensureObject(null, "test")).toThrow(
        "Expected object for test, got null/undefined",
      );
    });

    it("should throw on undefined", () => {
      expect(() => ensureObject(undefined, "test")).toThrow(
        "Expected object for test, got null/undefined",
      );
    });

    it("should throw on non-object", () => {
      expect(() => ensureObject("string", "test")).toThrow(
        "Expected object for test, got string",
      );
      expect(() => ensureObject(123, "test")).toThrow(
        "Expected object for test, got number",
      );
    });
  });
  ...
  describe("ensureArray", () => {
    ...
    it("should throw on null", () => {
      expect(() => ensureArray(null, "test")).toThrow(
        "Expected array for test, got null/undefined",
      );
    });

    it("should throw on undefined", () => {
      expect(() => ensureArray(undefined, "test")).toThrow(
        "Expected array for test, got null/undefined",
      );
    });

    it("should throw on non-array", () => {
      expect(() => ensureArray({ foo: "bar" }, "test")).toThrow(
        "Expected array for test, got object",
      );
      expect(() => ensureArray("string", "test")).toThrow(
        "Expected array for test, got string",
      );
    });
  });
  ...
  describe("ensureString", () => {
    ...
    it("should throw on null", () => {
      expect(() => ensureString(null, "test")).toThrow(
        "Expected string for test, got null/undefined",
      );
    });

    it("should throw on non-string", () => {
      expect(() => ensureString(123, "test")).toThrow(
        "Expected string for test, got number",
      );
      expect(() => ensureString({}, "test")).toThrow(
        "Expected string for test, got object",
      );
    });
  });
  ...
  describe("ensureNumber", () => {
    ...
    it("should throw on NaN", () => {
      expect(() => ensureNumber(NaN, "test")).toThrow(
        "Expected number for test, got number",
      );
    });

    it("should throw on non-number", () => {
      expect(() => ensureNumber("123", "test")).toThrow(
        "Expected number for test, got string",
      );
      expect(() => ensureNumber(null, "test")).toThrow(
        "Expected number for test, got null/undefined",
      );
    });
  });
