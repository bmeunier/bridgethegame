...
export function ensureObject<T extends object>(v: unknown, name: string): T {
  if (v == null || typeof v !== 'object') {
    throw new Error(`Expected object for ${name}, got ${v == null ? 'null/undefined' : typeof v}`);
  }
  return v as T;
}
...
export function ensureArray<T>(v: unknown, name: string): T[] {
  if (!Array.isArray(v)) {
    throw new Error(`Expected array for ${name}, got ${v == null ? 'null/undefined' : typeof v}`);
  }
  return v as T[];
}
...
export function ensureString(v: unknown, name: string): string {
  if (typeof v !== 'string') {
    throw new Error(`Expected string for ${name}, got ${v == null ? 'null/undefined' : typeof v}`);
  }
  return v;
}
...
export function ensureNumber(v: unknown, name: string): number {
  if (typeof v !== 'number' || isNaN(v)) {
    throw new Error(`Expected number for ${name}, got ${v == null ? 'null/undefined' : typeof v}`);
  }
  return v;
}
...
export function safeEntries<T extends object>(
  ...
  if (obj == null) {
    console.warn('safeEntries called with null/undefined, returning empty array');
    return [];
  }
...
export function safeValues<T extends object>(obj: T | null | undefined): Array<T[keyof T]> {
  if (obj == null) {
    console.warn('safeValues called with null/undefined, returning empty array');
    return [];
  }
